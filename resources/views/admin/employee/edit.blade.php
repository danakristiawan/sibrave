                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="post"
                            action="{{ url('admin/employee/'. $employee->id.'') }}" autocomplete="off">
                            @method('put')
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('nik') is-invalid  @enderror"
                                        ...
                                        placeholder="Isi 16 digit NIK" readonly>
                                    @error('nik')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control @error('tempatlhr') is-invalid  @enderror"
                                        name="tempatlhr" value="{{ $employee->tempatlhr }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('alamat') is-invalid  @enderror"
                                        name="alamat" value="{{ $employee->alamat }}"
